pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/taylo271'                                   //<-----change this to your MiamiID!
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/miamiohTaylo271/225-lab4-2.git'     //<-----change this to match this new repository!
        KUBECONFIG = credentials('taylo271-225')                           //<-----change this to match your kubernetes credentials (MiamiID-225)! 
    }
